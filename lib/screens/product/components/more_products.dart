...
import 'package:madhvani_traders_app/screens/product/components/product_card.dart';
...
class MoreProducts extends StatelessWidget {
  final List<Product> products = [
    Product(
        'assets/sugar.png',
        'Kakirasugar 1kg pack',
        'Extracted from cane grown from lush plantations. The sweet sparkling crystals sweeten dishes with their distinctive taste and flavour.',
        5000),
    Product(
        'assets/soap.png',
        'Laundry bar soap',
